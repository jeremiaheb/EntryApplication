$(function () {
  ...
  function getStationDistance() {
    const latitude_fields = $(
      "input.coords[name*='latitude_in_northern_degrees']",
    );
    const longitude_fields = $(
      "input.coords[name*='longitude_in_western_degrees']",
    );
  ...
  function setDiverTypeLabelOnLoad() {
    $(".diver_type_label").each(function () {
      var $rep_type = $(this)
        .closest(".replicate_record")
        .find(".replicate_type :input")
        .val()
        .toUpperCase();
